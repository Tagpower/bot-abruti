...
const objets_M = ["porcs","puceaux","rouleaux de PQ","rouleaux de PQ usagés","connards","tabourets","tractopelles","pineux","mongols",
				...
				"meurtriers récidivistes","vers d'urètre","rats","couillons","incapables","malpropres","queutards","péquenauds","clampins"];
...
const objets_F = ["truies","chiennes","pucelles","salopes","putains","pourritures","connasses","ordures","couilles molles","catins","vulves","vulves dégoulinantes",
				...
				"foutrelles","bennes à ordures","fosses septiques","têtes de bite","feignasses","sous-races","erreurs de la nature","hontes de l'Humanité"];
...
const objets_substance_F = ["poches à","putes à","flaques de","capotes remplies de","serviettes à","poubelles à", "mangeuses de", "brosses à", "piscines à"];
